...
//    if ([className isEqualToString:@"DDMyExpressListController"] ||
//        [className isEqualToString:@"DDOrdersListViewController"]) {
//        UIPanGestureRecognizer *panGesture = (UIPanGestureRecognizer *)gestureRecognizer;
//        CGPoint touchLocation = [touch locationInView:self.view];
//        //NSLog(@"%f",[pan velocityInView:self.view].x);
//        if (touchLocation.y > 64) {
//            return NO;
//        } else {
//            return YES;
//        }
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
    //if (gestureRecognizer == self.panGestureRecognizer) {
        ...
        NSLog(@"%f",[panGesture velocityInView:self.view].x);
