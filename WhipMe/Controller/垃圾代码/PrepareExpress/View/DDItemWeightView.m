...
@implementation DDItemWeightView
#pragma mark - 类的初始化方法
...
{
    NSString *itemWeight = @"小于1公斤物品/小于2公斤物品/小于3公斤物品/小于4公斤物品/小于5公斤物品/小于6公斤物品/小于7公斤物品/小于8公斤物品/小于9公斤物品/小于10公斤物品/小于11公斤物品/小于12公斤物品/小于13公斤物品/小于14公斤物品/小于15公斤物品";
...
-(void) cancelAction
{
    if ([_delegate respondsToSelector:@selector(itemWeightCancelAction)]) {
        [_delegate itemWeightCancelAction];
    }
}
...
- (void) okAction
{
    ...
    if ([_delegate respondsToSelector:@selector(itemWeightOKAction:)]) {
        [_delegate itemWeightOKAction:string];
    }
}
...
- (void)showCurrentWeight:(NSString *)currentWeight
{
    ...
    NSInteger index = [firstArray indexOfObject:currentWeight];
