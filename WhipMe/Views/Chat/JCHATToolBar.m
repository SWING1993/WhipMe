...
- (void)drawRect:(CGRect)rect {
    ...
    [self setFrame:CGRectMake(0, [Define screenHeight] + 20.0 - 45, self.bounds.size.width, 45)];
    ...
    [self.startRecordButton setBackgroundColor:[UIColor colorWithRGBHex:0x3f80dc]];
    ...
    self.recordAnimationView = [[JCHATRecordAnimationView alloc] initWithFrame:CGRectMake(([Define screenWidth]-140)/2, ([Define screenHeight] - 44.0 - 49.0 - 140)/2, 140, 140)];
...
- (void)addtoolbar {
    self.toolbar.frame = CGRectMake(0, 0, [Define screenWidth], 45);
