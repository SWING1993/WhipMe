...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {
  DebugLog(@"_progress=  %f", _progress.fractionCompleted);
}

- (void)DeleteThisImage:(NSInteger)ThisImageIndex {
    DebugLog(@"ThisImageIndex---%ld", (long)ThisImageIndex );
    DebugLog(@"_currentPhotoIndex---%lu", (unsigned long)_currentPhotoIndex );
    if ( ThisImageIndex == 0 ) {
