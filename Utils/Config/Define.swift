...
let kYellow: UIColor = Define.RGBColorFloat(251, g: 187, b: 100)
let kColorLight: UIColor = Define.RGBColorFloat(182.0, g: 182.0, b: 182.0)
let kColorTextLight: UIColor = Define.RGBColorFloat(153.0, g: 153.0, b: 153.0)
...
class Define: NSObject {
    ...
    class func kUserUnReadCountNotification() -> String {
        return "userUnReadCountKey"
    }
    
    class func kAllConversationsNotification() -> String {
        return "allConversationListNotification"
    }
